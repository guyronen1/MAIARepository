...
export class SideMenuComponent {
  ...
  sections: NavSection[] = [
    ...
    },
    {
      ...
      items: [
        { label: 'Users',     icon: svgIcon('M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-1.13a4 4 0 100-8 4 4 0 000 8z'), route: '/config/users' },
        { label: 'Audit Log', icon: svgIcon('M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01'), route: '/config/audit' },
      ]
    },
  ];
}
